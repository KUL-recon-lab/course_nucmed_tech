...
figure is for 180$^{\circ}$. A sinogram for 360$^{\circ}$\ shows a full period of
...
projections over 180$^{\circ}$ or 360$^{\circ}$. Because the spatial resolution
...
\caption{\label{fig:osem} \emph{Illustration of OSEM: there are 160
    ...
    360$^{\circ}$. OSEM used 40 subsets of 4 projections each, the first
    subset has projections at 0$^{\circ}$, 90$^{\circ}$, 180$^{\circ}$ and
    270$^{\circ}$. The second subset starts at 45$^{\circ}$ and so on. One
...
acquired at 0$^{\circ}$, 90$^{\circ}$, 180$^{\circ}$ and 270$^{\circ}$. The
second subset has the projections at 45$^{\circ}$, 135$^{\circ}$,
225$^{\circ}$ and 315$^{\circ}$ and so on. One OSEM iteration consists of
