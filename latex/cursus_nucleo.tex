...
The most important single photon isotope \Tc\ is an example of this
mode. \Tc\ is a metastable daughter product of $^{99}$Mo (half life 66
hours). \Tc\ decays to $^{99}$Tc (half life 6 hours) by emitting a
...
\footnote{There are only 5 places worldwide where $^{99}$Mo is
  ...
  4 where it can be processed to produce \Tc\ generators (one in
...
\begin{figure}[htb]
\centering
\includegraphics[width = 0.8\textwidth]{fig_In111.eps}
\caption{\label{fig:In111} \emph{Decay scheme of $^{111}$In, by
    electron capture. The scheme is dominated by the emission of two
    gamma rays (171 and 245 keV). These gamma rays can be involved in
    production of conversion electrons. A more complete table is given
...
\begin{figure}[tb]
\centering
\includegraphics[width = 0.5\textwidth]{fig_jnpos.eps}
...
As shown in appendix \pref{app:poisson}, the probability of measuring $n$
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_jnpmt.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.6\figone]{fig_multicrystal.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.7\figone]{fig_fwhm.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=1.5\figone]{fig_spect_pet_ct.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=1.2\figone]{fig_collimators.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_lenscollimator.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_collimator_calc.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_collimatorpsf.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_petdetectorpair.eps}
...
\ref{fig:positron_error}, there is a deviation of about 0.5\degrees, which
corresponds to a 2.0 mm offset for a detector ring with 80 cm diameter.
%
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_positron_error.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figsmall]{fig_doi.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_pet_septa.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_pet_random_enzo.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_jnpet.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_pv.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_scatter_gammacamera.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_scatter_spectrum.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_TEW_scatter.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_pet_scatter.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_jngamma.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_linearity.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_energy_corr.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=1.0\figbig]{fig_PETsens.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_dead_time.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_pet_parallel.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_jnwb.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_renaldynimg.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.9\figone]{fig_renalrois.eps}
  \includegraphics[width=\figone]{fig_renalplot.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_sinogram.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.7\figone]{fig_fbp_math.eps}
...
\pref{app:cs}.  In words: the 1-D Fourier transform of the projection
...
\begin{figure}[tb]
\centering
\includegraphics[width=1.2\figone]{fig_fouriertheorem.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.8\figbig]{fig_jnproj_sino.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=1.2\figone]{fig_backproj.eps}
...
\begin{eqnarray}
 ...
 b(x,y) & = & (\mbox{backproj}(\mbox{proj}(f))(x,y) \; = \;
  \frac{A}{\sqrt{x^2 + y^2}}.
\end{eqnarray}
A more rigorous derivation is given in appendix \pref{app:bprojproj}.
...
which is done in appendix \pref{app:ramp}. The ramp filter and the
...
is the point spread function computed in section \pref{sec:backprojection}.
...
\begin{figure}[tb]
%\centering
  \includegraphics[width=0.9\figone]{fig_rampfilter1.eps}
  \includegraphics[width=0.9\figone]{fig_rampfilter2.eps}
...
Starting from eq (\pref{eq:ct_proj}) we obtain:
\begin{equation}
...
(\pref{eq:pet_proj}). So we can correct for attenuation by multiplying the
emission measurement $q(d)$ with the correction factor $N_0 / N(d)$.
For SPECT (equation (\pref{eq:spect_proj})), this is not possible.
...
(\pref{eq:spect_proj}) and (\ref{eq:pet_proj}). However, we want a
...
photons were expected (see eq. (\pref{jn:Poisson})):
\begin{equation}
...
reader is referred to appendix \pref{app:em} for some notes on convergence.
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.8\figone]{fig_expected_a_b.eps}
...
\pref{app:expected_a_b}. The expected value of $a$, given $N$ is:
\begin{equation}
...
is identical to the problem studied in section \pref{sec:expect_a_b}, and 
...
(\pref{eq:jnbackproj}). The digital version clearly shows that
...
Comparing with (\pref{eq:jnmlgrad}) shows that the ML-algorithm is really a
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.8\figbig]{fig_jnfbpml.eps}
...
%================================================
As explained in section \pref{sec:randoms}, an estimate of the randoms
...
the scatter contribution in SPECT (section \pref{sec:spectscatcor})
and PET (section \pref{sec:petscatcor}). If an estimate of such an
...
of (\pref{jn:mlproj}) is then extended as 
\begin{equation}
...
Bayesian expression (\pref{eq:jnpost}). Instead of ignoring the prior,
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_mlem_converge.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_mlem_1000iter.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=1.1\figbig]{fig_osem.eps}
...
\pref{fig:collimators}). Another example is 3D PET (section
\pref{sec:2D3DPET}). Three approaches to fully 3D reconstruction are
discussed below.
...
general, the coefficients $c_{ij}$ in (\pref{eq:jnmlem}) can be directly used
...
\pref{tab:crystals}). In current scanners, LSO (or LYSO) is mostly
...
\begin{figure}[t]
\centering
  \includegraphics[width=0.8\figbig]{fig_tofsino.eps}
  \vspace{-4mm}
...
\begin{figure}[tb]
\centering
  \includegraphics[width=\figmedium]{fig_TOF_projbproj.eps}
  ...
  in the non-TOF case (fig \pref{fig:backproj}).}}
\end{figure}
...
(eq. \pref{jn:mlproj}), but of course, the elements $c_{ij}$ of the
...
backprojection. See appendix \pref{app:bprojproj} for a more
...
(\pref{eq:bprojvalue}). The projection and backprojection operators
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_TOF_matej.eps}
...
sensitivities (see equation \pref{eq:petnorm}), and for TOF-PET, also
the width of the TOF-resolution.

\begin{figure}[htb]
\centering
\includegraphics[width=\figbig]{fig_resol_line_cone.eps}
...
\end{figure}
In section \pref{sec:collimation}, we have seen that gamma cameras
...
\begin{figure}[htb]
\centering
\includegraphics[width=\figbig]{fig_resol_spectpet.eps}
...
\begin{figure}[htb]
\centering
\includegraphics[width=\figbig]{fig_resol_petgibbs.eps}
...
\begin{figure}[htb]
\centering
\includegraphics[width=\figbig]{fig_resol_gibbs.eps}
...
\begin{figure}[htb]
\centering
\includegraphics[width=\figbig]{fig_resol_sinc.eps}
...
than for PET (section \pref{sec:attencor}). For PET, the
...
(\pref{eq:jnmlem}). Remember that MLEM deals with attenuation by simulating it,
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_specttrans.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_pettrans.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_transproj.eps}
...
emitted by the source (see eq. (\pref{eq:attencor}) and
...
algorithm or MAP-algorithm (see section \pref{sec:bayes}).
...
amplitude. As argued in section \pref{sec:regularization}, this can be expected,
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_pettranslang.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_pettranskort.eps}
...
%=========================
\begin{figure}[tbp]
\centering \includegraphics[width=0.6\figbig]{fig_ct.eps} 
...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.6\figbig]{fig_petct.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.7\figbig]{fig_petctimg.eps}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.5\figbig]{fig_ctspectrum.eps}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.6\figbig]{fig_petctconversion.eps}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.9\figbig]{fig_CTcontrast.eps}
...
photons is in the denominator of equation (\pref{eq:attencor}), so the
...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.7\figbig]{fig_petctbreathing.eps}
...
\begin{figure}[tbp]
\centering
\includegraphics[width=0.9\figbig]{fig_petctatcor.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_en_lin_unif.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_qc_pmt.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_qc_linproblem.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_qc_gain.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_qc_enresol.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_qc_linearity.eps}
...
\begin{figure}[t]
\centering
\includegraphics[width=\figbig]{fig_cor.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=0.7\figone]{fig_gamma_parallel.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=1\figmedium]{fig_jaszczakphantom.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figsmall]{fig_wellcounter.eps}
...
%
\begin{figure}[tb]
  \includegraphics[width=0.35\textwidth]{fig_wellcountersens.eps}
  \includegraphics[width=0.61\textwidth]{fig_wellcounter2.eps}
...
\preq{eq:collim:fwhm}, but this time, we cannot ignore the curvature
...
\begin{eqnarray}
  \mbox{sensitivity}(D) = 1 - \mbox{escape-chance}(D) =
     \frac{1}{2}\left(1 + \frac{D}{\sqrt{D^2 +
     H^2}}\right). \label{eq:wellcountersens}
\end{eqnarray}
...
%
\begin{figure}[thb]
\includegraphics[width=0.8\textwidth]{fig_gasdetector.eps}
...
photon counting devices, see section \pref{sec:deadtime}).
...
\begin{figure}[tb]
\hspace{-4mm}\includegraphics[width=0.53\textwidth]{fig_dosecalib1.eps}
        \includegraphics[width=0.53\textwidth]{fig_dosecalib2.eps}
...
into Bq/ml (see section \pref{sec:scalefactor}).
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_dyncardio.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_kinemodel.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figbig]{fig_kinemodel2.eps}
...
tool. Appendix \pref{app:laplace} gives the definition and a short table of the
...
\pref{app:laplace}) and produces the operational function:
\begin{equation}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_3comp_ci.eps}
...
values. The tissue curve in fig.\ \pref{fig:kinemodel} is the result of
...
consumption can be simplified. Figure \pref{fig:kinemodel} shows a typical
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figone]{fig_bias_var.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figmedium]{fig_biol_singlephoton.png}
...
\begin{figure}[tbh]
\centering
\includegraphics[width=\figmedium]{fig_rampfilter2_app.eps}
...
\begin{figure}[tb]
\centering
\includegraphics[width=\figmedium]{fig_rampfilter_app.eps}
